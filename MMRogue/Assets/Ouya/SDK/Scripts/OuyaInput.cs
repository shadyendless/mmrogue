...
public static class OuyaInput
{
    ...
    private static bool GetButton(OuyaButton button, ButtonAction buttonAction, OuyaPlayer player)
    {
        ...
        // this is not really needed in CLARK Ã¢â‚¬â€œ just framework coherence
        int playerIndex = (int)player - 1;
        ...
        if (playerController != null)
        {
            ...
            switch (mapType)
            {
				...
				switch (button)
				{
					...
					// not defined so far Ã¢â‚¬â€œ or don't exist
				...
				switch (button)
				{
					...
					// not defined so far Ã¢â‚¬â€œ or don't exist on OUYA
					case OuyaButton.START: 	return false;
					case OuyaButton.SYSTEM: return false;
					case OuyaButton.SELECT: return false;	
					default: return false;
				...
				switch (button)
				{
					...
					// this can't be helped Ã¢â‚¬â€œ at leas we won't fire d-pad input when pressing action buttons
					case OuyaButton.DU:
    ...
    public static float GetJoystickAngle(OuyaJoystick joystick, OuyaPlayer player)
    {
         ...
         * (x-positive-axis is 0Ã‚Â° / y-positive axis is 90Ã‚Â° / x-negative axis is 180Ã‚Â° / y-negative-axis is 270Ã‚Â°)
